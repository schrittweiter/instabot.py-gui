...
app.controller('appController', function appController($scope) {
    ...
    $scope.bot = {
        ...
        'hashtags_white':   localStorage.getItem('hashtags_white'),
        'hashtags_black':   localStorage.getItem('hashtags_black'),
        'user_black':       localStorage.getItem('user_black'),
        'user_white':       localStorage.getItem('user_white')
    }
    ...
    $scope.checkLogin = function(bot) {
        ...
        localStorage.setItem('hashtags_white', bot.hashtags_white);
        localStorage.setItem('hashtags_black', bot.hashtags_black);
        localStorage.setItem('user_black', bot.user_black);
        localStorage.setItem('user_white', bot.user_white);
        ...
        $.get('https://d212rkvo8t62el.cloudfront.net/tag/'+hashtag, function( data ) {
            ...
            if(data.results.length > 0) {
                ...
                $.each(data.results, function(i, item) {
                    if( $.inArray(item.tag, tags_compare) != -1){
                    } else {
